...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=5906, help='seed')
    ...
    parser.add_argument('--ch_genc2n', type=int, default=64, help='channel size in C2N generator')
    ...
    parser.add_argument('--vgg_w', type=float, default=1.0, help='weight of vgg19 loss')
    parser.add_argument('--tv_w', type=float, default=0.2, help='weight of total variance loss')
    parser.add_argument('--back_w', type=float, default=5.0, help='weight of background preserving loss')
    ...
    parser.add_argument('--sobel_w', type=float, default=0.2, help='weight of sobel loss')
    #parser.add_argument('--bgm', type=float, default=0.2, help='weight of bgm loss')
